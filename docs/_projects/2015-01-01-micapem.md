...
- [La cogeneración en detalle](#la-cogeneración-en-detalle)
  ...
  - [Esta es una sección de prueba para ver como trabajan los enlaces en la página](#esta-es-una-sección-de-prueba-para-ver-como-trabajan-los-enlaces-en-la-página)
...
### Esta es una sección de prueba para ver como trabajan los enlaces en la página
